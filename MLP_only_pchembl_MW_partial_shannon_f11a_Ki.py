...
# constructing a new df table as df_new containng only MW, partial shannon values (not total shannon) and target labels
...
# Normalizing the train and test labels
...
plt.savefig('MLP_only_Ki_pred_atom_labels_wo_Milvexian_BMS_partial_shannon.png')
plt.show()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig('MLP_only_loss@epochs_pChEMBL_MW_partial_shannon')
####------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------